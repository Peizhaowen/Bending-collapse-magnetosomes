function scriptfilename = BentCuboctahedronCreateMagnetosomeHysteresisScript(x,y,z,d,N,b,a,theta,phi)
	path = 'mesh_bent';
	domainpath = 'domainstates_bent_cuboctahedron';
	merrillpath = 'D:/magnetosomes';
	scriptpath = 'D:/magnetosomes/scripts/hysteresis_bent_cuboctahedron';
	hysteresispath = 'hysteresis_bent_cuboctahedron';
	filename = sprintf('Cuboctahedron_%dx_%dy_%dz_%dd_%dN_%db', x, y, z, d, N, b);
	scriptfilename = sprintf('Cuboctahedron_%dx_%dy_%dz_%dd_%dN_%db_%ga', x, y, z, d, N, b, a);
