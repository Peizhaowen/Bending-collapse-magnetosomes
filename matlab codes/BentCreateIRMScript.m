function scriptfilename = BentCreateIRMScript(x,y,z,d,N,b,a,theta,phi)
	path = 'mesh_bent';
	domainpath = 'domainstates_bent_IRM';
	merrillpath = 'D:/magnetosomes';
	scriptpath = 'D:/magnetosomes/scripts/IRM_bent';
	IRMpath = 'IRM_bent';
	filename = sprintf('IRM%dx_%dy_%dz_%dd_%dN_%db', x, y, z, d, N, b);
	scriptfilename = sprintf('IRM%dx_%dy_%dz_%dd_%dN_%db_%ga', x, y, z, d, N, b, a);
