function [M, Mp, H, Mvec, Mr, Mpr, Hc, Hsw1, Hsw2, spec] = BentLoadOneHysteresis3d(x, y, z, d, N, b, r, a, Hinter)
    hys_path = 'D:/project_magnetosomes/hysteresis_bent3d'; 
    filename = sprintf('%s/3d%dx_%dy_%dz_%dd_%dN_%db_%dr_%da.hyst', hys_path, x, y, z, d, N, b, r, a);
