function [M, Mp, H, Mvec, Mr, Mpr, Hc, Hsw1, Hsw2, spec] = BentLoadOneHysteresis(x, y, z, d, N, b, a, Hinter)
     hys_path = 'D:/project_magnetosomes/hysteresis_bent'; 
%     hys_path = 'D:/project_magnetosomes/old/hysteresis_bent'; 
    filename = sprintf('%s/%dx_%dy_%dz_%dd_%dN_%db_%da.hyst', hys_path, x, y, z, d, N, b, a);
