function [E0, Eend] = BentLoadOneEnergyCheck(x, y, z, d, N, b, a, T,crystal)
% BentLoadOneEnergyCheck(40, 40, 40, 8, 10, 324,1,20,'co')
    energy_path = 'D:/project_magnetosomes/energy_bent_other';
    if crystal == 'c'
    ...
    filename = sprintf('%s_%gx_%gy_%gz_%gd_%dN_%db_%gT_%da.dat', crystal, x, y, z, d, N, b, T, a);
