function BentCreateMagnetosomeEnergyBarrierRepeatSelectedRMBatch3d(modelname, Tname, selected_num, split_index)    
    filename = Tname;
    merrillpath = 'D:/magnetosomes_thermal'; 
    scriptpath = 'scripts/energy_barriers_bent3d'; 
    batchpath = 'batch_energy_barriers_bent_ReadZoneandMin3d'; 
