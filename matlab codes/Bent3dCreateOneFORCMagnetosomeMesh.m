function Bent3dCreateOneFORCMagnetosomeMesh(x,y,z,d,N,b)
    % Bent3dCreateOneFORCMagnetosomeMesh(40,40,40,8,10,30)
	path = 'D:/magnetosomes/mesh_bent3d_FORC';
	cubitpath = 'D:/magnetosomes/cubit_bent3d_FORC'; 
	[~,~,~] = mkdir(path);
	[~,~,~] = mkdir(cubitpath);
    filename = sprintf('magnetosome3d_FORC_%dx_%dy_%dz_%dd_%dN_%db', x, y, z, d, N, b);
