function Tblocking = BentCalculateBlockingT3d(x, y, z, d, N, b, r)
% BentCalculateBlockingT3d(40, 40, 40, 8, 10, 30,3)

    T = [0:20:560 575]; 
    [E1, E2,dE] = BentCalculateEnergyBarrier3d(x, y, z, d, N, b, r, T);
%     E = (E1 + E2)/2;
    E = dE;
    tau0 = 1e-9; 
    k = 1.38e-23;
    ...
    Teff700 = T(find(t<=50,1));
    Teff = [Teff700:20:560 575];
    [Eeff1, Eeff2,dEeff] = BentCalculateEnergyBarrier3d(x, y, z, d, N, b, r,Teff);
    % Eeff = (Eeff1 + Eeff2)/2;
    Eeff(1) = dEeff(1);
    ...
    if Tfit(find(tfit<=2, 1)) > 0
        ...
        Tblocking = BentCalculateBlockingT3d(x, y, z, d, N, b,r-1);
    end
