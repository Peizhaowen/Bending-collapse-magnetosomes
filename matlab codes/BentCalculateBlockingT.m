function Tblocking = BentCalculateBlockingT(x, y, z, d, N, b,crystal)
% BentCalculateBlockingT(40, 40, 40, 8, 10, 0,'c')
% BentCalculateBlockingT(48, 40, 40, 3, 10, 180)
% BentPlotRelaxationTime(100, 100, 100, 3, 10, 0)
% BentPlotRelaxationTime(40, 40, 40, 8, 10, 180)

    T = [0:20:560 575]; 
    [E1, E2,dE] = BentCalculateEnergyBarrier(x, y, z, d, N, b, T,crystal);
%     E = (E1 + E2)/2;
    E = dE;
    tau0 = 1e-9; 
    k = 1.38e-23;
    ...
    [Eeff1, Eeff2, dEeff] = BentCalculateEnergyBarrier(x, y, z, d, N, b, Teff,crystal);
    % Eeff = (Eeff1 + Eeff2)/2;
    Eeff(1) = dEeff(1);
