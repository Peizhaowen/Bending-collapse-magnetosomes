function BentCreateMagnetosomeEnergyBarrierRepeatSelectedEBBatch3d(modelname, Tname, selected_num, split_index)
    merrillpath = 'D:/magnetosomes_thermal';
    scriptpath = 'scripts/energy_barriers_bent3d';
    batchpath = 'batch_energy_barriers_bent_repeat3d';
    [~,~,~] = mkdir(sprintf('%s/%s', merrillpath, batchpath)); 
    ...
    for n = 1:2
        for num = 1:5
            ...
            fprintf(fileID, '@IF EXIST "energy_bent3d/%s/%s.dat" (\n', modelname, scriptname);
