function BentCreateMagnetosomeEnergyRandomScript3d(x, y, z, d, N, b, r)
% BentCreateMagnetosomeEnergyRandomScript3d(40, 40, 40, 8, 10, 0, 1)
    ...
    inital_path = 'barrier_paths_initial_bent_random3d'; 
    final_path = 'barrier_paths_final_bent_random3d'; 
    energy_path = 'energy_bent_random3d'; 
    energylog_initial_path = 'energylog_initial_bent_random3d';
    energylog_final_path = 'energylog_final_bent_random3d';
    scriptpath = 'D:/magnetosomes_thermal/scripts/energy_barriers_bent_random3d'; 
    ...
    calculate_list = BentCreateMagnetosomeEnergyRandomCheckdirectionScript3d(x, y, z, d, N, b, r)
    ...
    for a = 1:length(calculate_list)
            filename = sprintf('3dco_%gx_%gy_%gz_%gd_%dN_%db_%dr_%gT_%d', x, y, z, d, N, b, r, T, calculate_list(a));
            % calculate energy
