function [M, H, Mr, Hcr, Mp,spec] = BentLoadOneIRMc(x, y, z, d, N, b, a, Hinter)
    hys_path = 'D:/project_magnetosomes/IRM_bent_Cuboctahedron'; 
    filename = sprintf('%s/IRM_Cuboctahedron_%dx_%dy_%dz_%dd_%dN_%db_%da.hyst', hys_path, x, y, z, d, N, b, a);
