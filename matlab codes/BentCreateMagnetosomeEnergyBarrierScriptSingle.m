function BentCreateMagnetosomeEnergyBarrierScriptSingle(x, y, z, d, N, b, crystal)
% BentCreateMagnetosomeEnergyBarrierScriptSingle(40, 40, 40, 3, 10, 0, 'c')
    path = 'mesh_bent'; 
    ...
    for n = 1:length(T)
        ...
        filename1 = sprintf('%s_%gx_%gy_%gz_%gd_%dN_%db_%gT', crystal, x, y, z, d, N, b, T(n));
        ...
        fprintf(fileID, 'ReadMagnetization %s/%s_n/%s.dat \n', ...
            groundstatepath, subfolder, filename1); 
